...
public class LightControl extends Activity{
    ...
    private TextView lightTtxtView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.toolbar_title)).setText("灯光控制");  //设置toolbar标题
        ...
        lightTtxtView= (TextView) findViewById(R.id.light);

        lightSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                lightTtxtView.setText(progress+"%");
            }
